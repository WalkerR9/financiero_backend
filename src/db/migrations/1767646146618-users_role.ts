...
export class UsersRole1767646146618 implements MigrationInterface {
    name = 'UsersRole1767646146618'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_6fc84ea008dd1a0578fbe4a3864\` ON \`mnt_roles_privileges\``);
        await queryRunner.query(`DROP INDEX \`FK_753a32c59a584e1bfc5c0539769\` ON \`mnt_roles_privileges\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`FK_753a32c59a584e1bfc5c0539769\` ON \`mnt_roles_privileges\` (\`privilegeId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_6fc84ea008dd1a0578fbe4a3864\` ON \`mnt_roles_privileges\` (\`roleId\`)`);
    }
